...
abstract class AppLocalizations {
  ...
  /// No description provided for @deleteAllNotesTitle.
  ///
  /// In en, this message translates to:
  /// **'Delete All Notes'**
  String get deleteAllNotesTitle;

  /// No description provided for @deleteAllNotesMessage.
  ///
  /// In en, this message translates to:
